...
public class DeltaXiangqiTestCases {
	...
	public void testCorrectInitialLocationPiecesRedPerspective() {
		...
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		p = game.getPieceAt(makeCoordinate(1, 8), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		// ELEPHANT
		...
		assertEquals(XiangqiColor.RED, p.getColor());
		// CANNON
		p = game.getPieceAt(makeCoordinate(3, 2), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		p = game.getPieceAt(makeCoordinate(3, 8), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		// SOLDIER
		...
		assertEquals(XiangqiColor.BLACK, p.getColor());	
		// HORSE
		p = game.getPieceAt(makeCoordinate(10, 2), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		p = game.getPieceAt(makeCoordinate(10, 8), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// ELEPHANT
		...
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// CANNON
		p = game.getPieceAt(makeCoordinate(8, 2), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		p = game.getPieceAt(makeCoordinate(8, 8), XiangqiColor.RED);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// SOLDIER
	...
	public void testCorrectInitialLocationPiecesBlackPerspective() {
		...
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		p = game.getPieceAt(makeCoordinate(1, 8), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// ELEPHANT
		...
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// CANNON
		p = game.getPieceAt(makeCoordinate(3, 2), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		p = game.getPieceAt(makeCoordinate(3, 8), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.BLACK, p.getColor());
		// SOLDIER
		...
		assertEquals(XiangqiColor.RED, p.getColor());	
		// HORSE
		p = game.getPieceAt(makeCoordinate(10, 2), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		p = game.getPieceAt(makeCoordinate(10, 8), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.HORSE, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		// ELEPHANT
		...
		assertEquals(XiangqiColor.RED, p.getColor());
		// CANNON
		p = game.getPieceAt(makeCoordinate(8, 2), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		p = game.getPieceAt(makeCoordinate(8, 8), XiangqiColor.BLACK);
		assertEquals(XiangqiPieceType.CANNON, p.getPieceType());
		assertEquals(XiangqiColor.RED, p.getColor());
		// SOLDIER
	...
	@Test
	public void testMakeValidMoveHorse() {
		// Move up and left
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 1))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 1))); // BLACK
		// Move down and right
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 1), makeCoordinate(1, 2))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 1), makeCoordinate(1, 2))); // BLACK
		// Move up and right
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 8), makeCoordinate(3, 9))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 8), makeCoordinate(3, 9))); // BLACK
		// Move down and right
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 9), makeCoordinate(1, 8))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 9), makeCoordinate(1, 8))); // BLACK
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 3))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 3))); // BLACK
		// Move right and down
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // BLACK
		// Move left and up
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(3, 3))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(3, 3))); // BLACK
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(4, 4))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(4, 4))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 4), makeCoordinate(6, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 4), makeCoordinate(6, 5))); // BLACK
		
		// Take another piece of opposite color
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(6, 5), makeCoordinate(7, 7))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(6, 5), makeCoordinate(7, 7))); // BLACK
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(7, 7), makeCoordinate(8, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(7, 7), makeCoordinate(8, 5))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(8, 5), makeCoordinate(9, 7))); // RED
	}
	
	@Test
	public void testMakeinValidMoveHorse() {
		// RED turn - try to move not following the rule for Horse
		...
		assertTrue(game.getMoveMessage().length() >= 1);
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(1, 2), makeCoordinate(2, 1)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 3))); // RED turn - valid move
		
		// BLACK turn - try to move not following the rule for Horse
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(1, 2), makeCoordinate(2, 2)));
		assertTrue(game.getMoveMessage().length() >= 1);
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(1, 2), makeCoordinate(2, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		...
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 2), makeCoordinate(3, 3))); // BLACK turn - valid move
		
		// RED turn - try to take piece of same color
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 3), makeCoordinate(4, 5)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // RED turn - valid move
		
		// BLACK turn - try to take piece of same color
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 3), makeCoordinate(4, 5)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 3), makeCoordinate(2, 5))); // BLACK turn - valid move
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(4, 4))); // RED turn - valid move
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 5), makeCoordinate(4, 4))); // BLACK turn - valid move
		
		// RED turn - try to move horizontal direction when being blocked
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(4, 4), makeCoordinate(5, 2)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 4), makeCoordinate(6, 5))); // RED turn - valid move
		
		// BLACK turn - try to move horizontal direction when being blocked
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(4, 4), makeCoordinate(5, 2)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 4), makeCoordinate(6, 5))); // BLACK turn - valid move
		
		// RED turn - try to move vertical direction when being blocked
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(6, 5), makeCoordinate(8, 4)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(6, 5), makeCoordinate(5, 7))); // RED turn - valid move
		
		// BLACK turn - try to move vertical direction when being blocked
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(6, 5), makeCoordinate(8, 4)));
		assertTrue(game.getMoveMessage().length() >= 1);
	}
	
	@Test
	public void testMakeValidMoveCannon() {
		// Move around horizontally and vertically
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(5, 2))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(5, 2))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(5, 2), makeCoordinate(3, 2))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(5, 2), makeCoordinate(3, 2))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 5))); // BLACK
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 5), makeCoordinate(3, 2))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 5), makeCoordinate(3, 2))); // BLACK
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 5))); // BLACK
		
		// Take another piece of opposite color
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 5), makeCoordinate(7, 5))); // RED
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 5), makeCoordinate(7, 5))); // BLACK
	}
	
	@Test
	public void testMakeInvalidMoveCannon() {
		// RED turn - try to move not following the rule for Cannon
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(2, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(5, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		// RED turn - make no movement
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 2)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(4, 2))); // RED turn - valid move
		
		// BLACK turn - try to move not following the rule for Cannon
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(2, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(5, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		// BLACK turn - make no movement
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(3, 2), makeCoordinate(3, 2)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 2), makeCoordinate(4, 2))); // BLACK turn - valid move
		
		// RED turn - try to move over another piece without taking any piece of opposite color
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(4, 2), makeCoordinate(4, 4)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		// RED turn - try to take piece of same color
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(4, 2), makeCoordinate(4, 5)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 2), makeCoordinate(7, 2))); // RED turn - valid move
		
		// BLACK turn - try to move over another piece without taking any piece of opposite color
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(4, 2), makeCoordinate(4, 4)));
		assertTrue(game.getMoveMessage().length() >= 1);
		...
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 2), makeCoordinate(7, 2))); // BLACK turn - valid move
		
		// RED turn - try to take piece of opposite color with no obstacle in between
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(7, 2), makeCoordinate(7, 3)));
		assertTrue(game.getMoveMessage().length() >= 1);
		
		// RED turn - try to take piece of opposite color moving over more than one piece
		assertEquals(MoveResult.ILLEGAL, game.makeMove(makeCoordinate(7, 2), makeCoordinate(7, 7)));
		assertTrue(game.getMoveMessage().length() >= 1);
	}
	...
	@Test
	public void testForPerpetualBlackWin() {
		// Turn 1
		...
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 1), makeCoordinate(1, 1))); // BLACK turn
		// Turn 5
		assertEquals(MoveResult.BLACK_WINS, game.makeMove(makeCoordinate(1, 1), makeCoordinate(2, 1))); // RED turn
	}
	
	@Test
	public void testForPerpetualRedWin() {
		// Turn 1
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 5), makeCoordinate(5, 5))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(4, 1), makeCoordinate(5, 1))); // BLACK turn
		// Turn 2
		...
		// Turn 5
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 1), makeCoordinate(1, 1))); // RED turn
		assertEquals(MoveResult.RED_WINS, game.makeMove(makeCoordinate(2, 1), makeCoordinate(1, 1))); // BLACK turn
	}
	
	@Test
	public void testForCheckMate() {
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 1), makeCoordinate(2, 1))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 9), makeCoordinate(2, 9))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 1), makeCoordinate(2, 4))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 9), makeCoordinate(1, 9))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 4), makeCoordinate(9, 4))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 9), makeCoordinate(2, 9))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(9, 4), makeCoordinate(9, 3))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 9), makeCoordinate(1, 9))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 9), makeCoordinate(2, 9))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 3), makeCoordinate(3, 1))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 9), makeCoordinate(2, 4))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 7), makeCoordinate(3, 9))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(9, 3), makeCoordinate(10, 3))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(3, 9), makeCoordinate(5, 7))); // BLACK turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(2, 4), makeCoordinate(9, 4))); // RED turn
		assertEquals(MoveResult.OK, game.makeMove(makeCoordinate(1, 9), makeCoordinate(2, 9))); // BLACK turn
		assertEquals(MoveResult.RED_WINS, game.makeMove(makeCoordinate(10, 3), makeCoordinate(10, 4))); // RED turn - CHECK-MATE
	}
}