...
import static xiangqi.studenthphong.common.XiangqiPieceImpl.makePiece;
...
public class GammaXiangqiGame implements XiangqiGame {
	...
	public GammaXiangqiGame() {
		...
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.CHARIOT, XiangqiColor.RED));
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.ELEPHANT, XiangqiColor.RED));
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.ELEPHANT, XiangqiColor.RED));
		...
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.ADVISOR, XiangqiColor.BLACK));
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.ELEPHANT, XiangqiColor.BLACK));
		boardPiece.add(XiangqiPieceImpl.makePiece(XiangqiPieceType.ELEPHANT, XiangqiColor.BLACK));
	...
	public MoveResult makeMove(XiangqiCoordinate source, XiangqiCoordinate destination) {
		...
		if (isValidCoordinate(source) && isValidCoordinate(destination)) {
			...
			p = findPieceAtLocation(newSource);
	...
	/**
	 * Function to determine the type of the piece at certain coordinate
	 * @param source coordinate of the starting piece
	 * @return type of the starting piece
	 */
	private XiangqiPiece findPieceAtLocation(XiangqiCoordinate source) {
		XiangqiPiece p = XiangqiPieceImpl.makePiece(XiangqiPieceType.NONE, XiangqiColor.NONE);
		int i;
		int start = source.getRank() * 10 + source.getFile();
		illegalCheck = true;
		// Go through the board to determine the piece at source location
